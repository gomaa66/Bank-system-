...
void Make_Transaction(void)
{
	//&& Accounts[Bank_Account_index].Account_Status==Active && Accounts[Transfer_Bank_Account_index].Account_Status==Active
	...
	else if (Accounts[Bank_Account_index].Balance>Money_Transfer )
	{
